...
RSpec.describe Commission do
  ...
  describe '#value' do
    ...
    it "has 3 keys" do
      expect(subject.keys).to eq([:insurance_commission, :assistance_commission, :drivy_commission])  
    end
  end
  ...
  describe '#insurance_commission' do
    subject { commission.send :insurance_commission }
  ...
  describe '#roadside_assistance_commission' do
    subject { commission.send :roadside_assistance_commission }
